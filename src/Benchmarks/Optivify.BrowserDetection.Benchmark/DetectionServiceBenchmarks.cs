...
public class DetectionServiceBenchmarks
{
    ...
    private readonly DetectionDataLoader detectionDataLoader;

    private readonly ClientHintsEngineDetector clientHintsEngineDetector;

    private readonly ClientHintsBrowserDetector clientHintsBrowserDetector;

    private readonly ClientHintsDeviceDetector clientHintsDeviceDetector;

    private readonly IEngineDetector[] engineDetectors;

    private readonly IBrowserDetector[] browserDetectors;

    private readonly IPlatformDetector[] platformDetectors;

    private readonly IDeviceTypeDetector[] deviceDetectors;

    private readonly IDeviceOperatingSystemDetector[] operatingSystemDetectors;

    private readonly IDeviceArchitectureDetector[] architectureDetectors;

    private readonly IDetectionService detectionServiceChromeOnWindows10;

    private readonly IDetectionService detectionServiceSafariOniOS;
